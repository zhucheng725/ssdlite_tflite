...
class AnchorBoxes(Layer):
    ...
    def call(self, x, mask=None):
        ...
        if K.image_data_format() == 'channels_last':
            ...
            feature_map_height = x.shape[1].value
            feature_map_width = x.shape[2].value
            feature_map_channels = x.shape[3].value
        ...
        #print(type(offset_width),type(step_width),type(offset_width),type(feature_map_width),type(step_width),type(feature_map_width))
        ...
        #cy = np.linspace(0.5*15,(0.5+19-1)*15,19)
        #cx = np.linspace(0.5 * 16,(0.5 + 19 - 1) * 16, 19)
